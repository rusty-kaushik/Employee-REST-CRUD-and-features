package com.ak.Employee.config;
...
public class OpenAPIConfig {
    ...
    public OpenAPI myOpenAPI() {
        ...
        Info info = new Info()
                ...
                .version("1.0")
                .contact(contact)
                .description("This API exposes endpoints to manage employee crud operations.").termsOfService("https://www.w3.org/Provider/Style/dummy.html")
                .license(mitLicense);
